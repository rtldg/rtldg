...
- [tf2centeredrockets](https://github.com/rtldg/tf2centeredrockets) - Provides the command sm_tf2centeredrockets <0|1> to shoot rockets from the center (like The Original) for any rocket launcher.
